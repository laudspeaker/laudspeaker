...
export class Migration1666691267551 implements MigrationInterface {
  name = 'Migration1666691267551';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "stats" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sentAmount" integer NOT NULL DEFAULT '0', "audienceId" uuid, CONSTRAINT "REL_321286655ffc8a394eb2a3c62e" UNIQUE ("audienceId"), CONSTRAINT "PK_c76e93dfef28ba9b6942f578ab1" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "installation" ("id" character varying NOT NULL, "installation" jsonb NOT NULL, CONSTRAINT "PK_f0cd0b17a45357b5e1da1da1680" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "state" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "installUrlOptions" jsonb NOT NULL, "now" TIMESTAMP NOT NULL, CONSTRAINT "PK_549ffd046ebab1336c3a8030a12" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "template" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "ownerId" character varying NOT NULL, "text" character varying, "style" character varying, "subject" character varying, "slackMessage" character varying, "type" character varying NOT NULL, CONSTRAINT "PK_fbae2ac36bd9b5e1e793b957b7f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "stats" ADD CONSTRAINT "FK_321286655ffc8a394eb2a3c62e6" FOREIGN KEY ("audienceId") REFERENCES "audience"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "stats" DROP CONSTRAINT "FK_321286655ffc8a394eb2a3c62e6"`
    );
