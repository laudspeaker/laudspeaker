...
export class TimeTriggersJobRelations1674737989068 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "job" ADD CONSTRAINT "FK_4230d15401eafcf6f4538208015" FOREIGN KEY ("ownerId") REFERENCES "account"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "job" DROP CONSTRAINT "FK_4230d15401eafcf6f4538208015"`);
        ...
        await queryRunner.query(`ALTER TABLE "job" ADD "owner" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "job" ADD "workflow" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "job" ADD "to" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "job" ADD "from" character varying NOT NULL`);
    }
