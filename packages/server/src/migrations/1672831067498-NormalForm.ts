...
export class NormalForm1672831067498 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "webhook_event" DROP CONSTRAINT "FK_1926eaf2385eacb83fa28c928ce"`
    );
    await queryRunner.query(
      `ALTER TABLE "audience" RENAME COLUMN "templates" TO "workflowId"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "webhook_event" ADD CONSTRAINT "FK_1926eaf2385eacb83fa28c928ce" FOREIGN KEY ("audienceId") REFERENCES "audience"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "audience" DROP COLUMN "workflowId"`);
    await queryRunner.query(
      `ALTER TABLE "audience" ADD "workflowId" text array NOT NULL DEFAULT '{}'`
    );
    await queryRunner.query(`ALTER TABLE "template" DROP COLUMN "audienceId"`);
    await queryRunner.query(
      `ALTER TABLE "workflow" ADD "audiences" text array NOT NULL DEFAULT '{}'`
    );
    await queryRunner.query(
      `ALTER TABLE "audience" RENAME COLUMN "workflowId" TO "templates"`
    );
    await queryRunner.query(
      `ALTER TABLE "webhook_event" ADD CONSTRAINT "FK_1926eaf2385eacb83fa28c928ce" FOREIGN KEY ("audienceId") REFERENCES "audience"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
