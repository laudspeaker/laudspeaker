...
export class RequeueMessageTable1702674806046 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "requeue" ("customerId" character varying NOT NULL, "ownerId" uuid NOT NULL, "stepId" uuid NOT NULL, "requeueAt" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_3bbb63d1d84962e9f6ce1c5dce9" PRIMARY KEY ("customerId", "ownerId", "stepId"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "requeue" ADD CONSTRAINT "FK_1fd53477df179d2f0c65c4f571b" FOREIGN KEY ("stepId") REFERENCES "step"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "requeue" DROP CONSTRAINT "FK_1fd53477df179d2f0c65c4f571b"`
    );
    await queryRunner.query(
