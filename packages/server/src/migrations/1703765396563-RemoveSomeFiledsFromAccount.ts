...
export class RemoveSomeFiledsFromAccount1703765396563 implements MigrationInterface {
    name = 'RemoveSomeFiledsFromAccount1703765396563'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "account" DROP CONSTRAINT "UQ_5ffe3d9a0bf0174b51f40eecdc6"`);
        ...
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "mailgunAPIKey"`);
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "sendingDomain"`);
        ...
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "posthogApiKey"`);
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "posthogProjectId"`);
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "posthogHostUrl"`);
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "posthogSmsKey"`);
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "posthogEmailKey"`);
        ...
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "firebaseCredentials"`);
        await queryRunner.query(`ALTER TABLE "account" DROP COLUMN "timezoneUTCOffset"`);
        await queryRunner.query(`ALTER TABLE "workspaces" ADD "messagesSent" integer NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "workspaces" DROP COLUMN "messagesSent"`);
        await queryRunner.query(`ALTER TABLE "account" ADD "timezoneUTCOffset" character varying NOT NULL DEFAULT 'UTC+00:00'`);
        await queryRunner.query(`ALTER TABLE "account" ADD "firebaseCredentials" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "account" ADD "posthogProjectId" text`);
        ...
        await queryRunner.query(`ALTER TABLE "account" ADD "sendingName" character varying`);
        await queryRunner.query(`ALTER TABLE "account" ADD "sendingEmail" character varying`);
        await queryRunner.query(`ALTER TABLE "account" ADD "sendingDomain" character varying`);
        await queryRunner.query(`ALTER TABLE "account" ADD "mailgunAPIKey" character varying`);
        await queryRunner.query(`ALTER TABLE "account" ADD "apiKey" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "account" ADD CONSTRAINT "UQ_5ffe3d9a0bf0174b51f40eecdc6" UNIQUE ("email", "apiKey")`);
    }
