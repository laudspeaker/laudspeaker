  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "workspace_sendgrid_connection" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "apiKey" character varying NOT NULL, "verificationKey" character varying NOT NULL, "workspaceId" uuid NOT NULL, CONSTRAINT "UQ_de05a1cb4fe890c8e5b8c3b95a3" UNIQUE ("workspaceId", "name"), CONSTRAINT "UQ_6c98b7882efa7f3023a59543396" UNIQUE ("workspaceId", "apiKey"), CONSTRAINT "PK_02e0e39a8932b266e7cf81fb250" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "workspace_twilio_connection" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "sid" character varying NOT NULL, "token" character varying NOT NULL, "from" character varying NOT NULL, "workspaceId" uuid NOT NULL, CONSTRAINT "UQ_38dbd687328ce2b636c0177eced" UNIQUE ("workspaceId", "name"), CONSTRAINT "UQ_51b94a50499a5dce9b825425076" UNIQUE ("workspaceId", "sid", "from"), CONSTRAINT "PK_39deb1d523e5320d78232f925ee" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "workspace_push_connection" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "pushPlatforms" jsonb NOT NULL DEFAULT '{}', "workspaceId" uuid NOT NULL, CONSTRAINT "UQ_968089603b666b30f18d134f890" UNIQUE ("workspaceId", "name"), CONSTRAINT "UQ_1b07bbfd37209fbe65202a590ec" UNIQUE ("workspaceId", "pushPlatforms"), CONSTRAINT "PK_e6d806d6c5969743af02db697ee" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "workspace_resend_connection" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "apiKey" character varying NOT NULL, "signingSecret" character varying NOT NULL, "sendingDomain" character varying NOT NULL, "workspaceId" uuid NOT NULL, CONSTRAINT "UQ_0a14ee8fa641ad6e29ff80f8ed3" UNIQUE ("workspaceId", "name"), CONSTRAINT "UQ_26461d89b7f6bd443fbca9898ec" UNIQUE ("workspaceId", "apiKey", "signingSecret", "sendingDomain"), CONSTRAINT "PK_f9b507739b524a220f79e05294e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "workspace_push_connection" ADD CONSTRAINT "UQ_1b07bbfd37209fbe65202a590ec" UNIQUE ("workspaceId", "pushPlatforms")`
    );
    await queryRunner.query(
