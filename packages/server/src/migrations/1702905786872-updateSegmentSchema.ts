...
export class UpdateSegmentSchema1702905786872 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "segment_customers" DROP CONSTRAINT "PK_738b7939074e8674168d2ec5d5e"`);
        ...
        await queryRunner.query(`ALTER TABLE "segment_customers" ALTER COLUMN "segmentId" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "segment_customers" DROP CONSTRAINT "FK_d3c2674d46610072d2d8b91f048"`);
        await queryRunner.query(`ALTER TABLE "segment_customers" ALTER COLUMN "segmentId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "segment_customers" ADD CONSTRAINT "FK_d3c2674d46610072d2d8b91f048" FOREIGN KEY ("segmentId") REFERENCES "segment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "segment_customers" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`);
        await queryRunner.query(`ALTER TABLE "segment_customers" ADD CONSTRAINT "PK_738b7939074e8674168d2ec5d5e" PRIMARY KEY ("id")`);
    }
