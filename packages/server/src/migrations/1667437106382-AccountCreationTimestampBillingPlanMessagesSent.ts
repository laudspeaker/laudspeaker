...
export class AccountCreationTimestampBillingPlanMessagesSent1667437106382
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "account" ADD "accountCreatedAt" TIMESTAMP NOT NULL DEFAULT now()`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "account" DROP COLUMN "accountCreatedAt"`
    );
  }
}
