...
export class Integrations1675165918041 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "integration" ADD CONSTRAINT "FK_0785ddd349cab5c06be05bf8528" FOREIGN KEY ("databaseId") REFERENCES "database"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "integration" DROP CONSTRAINT "FK_0785ddd349cab5c06be05bf8528"`
    );
    await queryRunner.query(
