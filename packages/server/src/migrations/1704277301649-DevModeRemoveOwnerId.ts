...
export class DevModeRemoveOwnerId1704277301649 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dev_mode" ADD CONSTRAINT "PK_ea7d4dcacd5c829777682c6d550" PRIMARY KEY ("journeyId", "workspaceId")`);
        await queryRunner.query(`ALTER TABLE "dev_mode" DROP COLUMN "ownerId"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "dev_mode" ADD "ownerId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "dev_mode" DROP CONSTRAINT "PK_ea7d4dcacd5c829777682c6d550"`);
        await queryRunner.query(`ALTER TABLE "dev_mode" ADD CONSTRAINT "PK_b73c33014d59aaf71e6bdefb54b" PRIMARY KEY ("ownerId", "journeyId", "workspaceId")`);
