...
import { AdditionalClickOptions, InAppState, SubMenuOptions } from "./types";
...
interface IInAppEditorAdditionalClicksProps {
...
const InAppEditorAdditionalClicks = ({
  inAppState,
  setInAppState,
  onOptionPick,
  actionData,
  handleBackClick,
  currentMainMode,
}: IInAppEditorAdditionalClicksProps) => {
...
export default InAppEditorAdditionalClicks;
