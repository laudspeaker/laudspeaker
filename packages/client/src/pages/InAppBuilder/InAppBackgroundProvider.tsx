...
import InAppBuilderBackgroundImage from "./Icons/InAppBuilderBackgroundImage.svg";
import GoogleIcon from "./Icons/Google.svg";
import FacebookIcon from "./Icons/Facebook.svg";

interface InAppBackgroundProviderProps {
  children: ReactNode;
}

const InAppBackgroundProvider: FC<InAppBackgroundProviderProps> = ({
  children,
}) => {
  return (
    <>
      <div className="h-screen pt-[60px] font-segoe flex">
        <div className="h-full p-[40px] w-[50%] bg-[#6366F1]">
          ...
          <div className="h-full flex justify-center items-center">
            <img className="w-full" src={InAppBuilderBackgroundImage} alt="" />
          </div>
        </div>
...
export default InAppBackgroundProvider;
