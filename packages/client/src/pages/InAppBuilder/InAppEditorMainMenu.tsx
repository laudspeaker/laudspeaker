...
const InAppEditorMainMenu: FC<MainMenuProps> = ({
  onOptionPick,
  inAppState,
}) => {
  const editorMenu = [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          hidden: inAppState.title.hidden,
        },
        {
          name: "Body",
          icon: (
        ...
        },
        {
          ...
          hidden: inAppState.media.hidden,
        },
        {
          name: "Shroud",
          icon: (
          ...
          hidden: inAppState.shroud.hidden,
        },
        {
          ...
          icon: (
            ...
            >
              <path
                d="M9 3.75C13.5 3.75 16.5 8.25 16.5 9C16.5 9.75 13.5 14.25 9 14.25C4.5 14.25 1.5 9.75 1.5 9C1.5 8.25 4.5 3.75 9 3.75Z"
                stroke="currentColor"
                strokeWidth="1.25"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          option: EditorMenuOptions.EDITOR,
          hidden: false,
        },
      ],
    },
      ...
      elements: [
        {
          ...
          hidden: inAppState.dismiss.hidden,
        },
        {
          name: "Primary Button",
          icon: (
          ...
          hidden: inAppState.primaryButton.hidden,
        },
      ],
    },
  ];
...
export default InAppEditorMainMenu;
