...
import { IAdditionalActionData, PreviousModes } from "./InAppEditor";
import { EditorMenuOptions } from "./InAppEditorMainMenu";
import { InAppState, SubMenuOptions } from "./types";

interface InAppEditorPersonalizationProps {
...
const InAppEditorPersonalization: FC<InAppEditorPersonalizationProps> = ({
  actionData,
  currentMainMode,
  inAppState,
  onOptionPick,
              ...
              onClick={() => {
                if (currentMainMode === EditorMenuOptions.BODY) {
                  setInAppState({
                    ...
                    body: {
                      ...inAppState.body,
                      content: inAppState.body.content + `{{ ${item.key} }}`,
                    },
                  });
                } else {
                  setInAppState({
                    ...
                    title: {
                      ...inAppState.title,
                      content: inAppState.title.content + `{{ ${item.key} }}`,
                    },
                  });
                }
              }}
...
export default InAppEditorPersonalization;
