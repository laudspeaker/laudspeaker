  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        fill="none"
      >
        <g clip-path="url(#clip0_185_4985)">
          <path
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_3834_7457)">
          <path
            d="M8.5 0C4.08214 0 0.5 3.58214 0.5 8C0.5 12.4179 4.08214 16 8.5 16C12.9179 16 16.5 12.4179 16.5 8C16.5 3.58214 12.9179 0 8.5 0ZM8.5 14.6429C4.83214 14.6429 1.85714 11.6679 1.85714 8C1.85714 4.33214 4.83214 1.35714 8.5 1.35714C12.1679 1.35714 15.1429 4.33214 15.1429 8C15.1429 11.6679 12.1679 14.6429 8.5 14.6429Z"
            fill="currentColor"
          />
          <path
            d="M6.27734 11.3177V10.1823C6.76345 10.5677 7.31207 10.7604 7.92318 10.7604C8.4197 10.7604 8.81554 10.6476 9.11068 10.4219C9.40929 10.1962 9.55859 9.89062 9.55859 9.50521C9.55859 8.65799 8.91102 8.23438 7.61589 8.23438H7.03776V7.26562H7.58984C8.73915 7.26562 9.3138 6.86632 9.3138 6.06771C9.3138 5.3316 8.86589 4.96354 7.97005 4.96354C7.47005 4.96354 6.99957 5.14236 6.55859 5.5V4.42708C7.06554 4.14236 7.6645 4 8.35547 4C9.01866 4 9.54991 4.16667 9.94922 4.5C10.3485 4.83333 10.5482 5.26042 10.5482 5.78125C10.5482 6.76389 10.0482 7.39583 9.04818 7.67708V7.69792C9.58637 7.75 10.0117 7.93924 10.3242 8.26562C10.6367 8.58854 10.793 8.99306 10.793 9.47917C10.793 10.1493 10.5412 10.691 10.0378 11.1042C9.53429 11.5139 8.87109 11.7188 8.04818 11.7188C7.30859 11.7188 6.71832 11.5851 6.27734 11.3177Z"
            fill="currentColor"
          />
        </g>
        <defs>
          <clipPath id="clip0_3834_7457">
            <rect
              width="16"
              height="16"
              fill="white"
