...
//   const { nodes, edges, triggers, selectedTrigger, selectedNode } =
...
//   const [filterId, setFilterId] = useState<string>(); // in redux
...
//           },
//         };
//         dispatch(setTriggers([...triggers, trigger]));
...
//       dispatch(setNodes([...nodes]));
//       dispatch(setEdges(edges.filter((edge) => edge.sourceHandle !== data)));
