...
import FlowBuilderStepper from "./FlowBuilderStepper";
  ...
  return (
    <div className="w-full flex justify-between items-center h-[60px] border-[1px] border-[#E5E7EB] bg-white font-segoe font-normal text-[16px] text-[#111827] leading-[24px]">
      <div className="flex items-center ml-[16px]">
        <div className="text-ellipsis max-w-[260px] mr-[16px]">{flowName}</div>
        <div className="cursor-pointer" onClick={handleOpenRenameModal}>
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
          ...
          >
            <g clip-path="url(#clip0_2222_57368)">
              <path
      ...
      <FlowBuilderStepper />
      <div
        className="flex justify-center items-center rounded-[4px] select-none cursor-pointer mr-[20px] bg-[#6366F1] border-[1px] border-[#6366F1] text-white px-[15px] py-[4px] font-roboto text-[14px] leading-[22px]"
