          ...
          {stepIdx < activeStep ? (
            <>
              {stepIdx !== stepperSteps.length - 1 ? (
                <div
                  className="absolute top-4 left-4 -ml-px mt-0.5 h-full w-0.5 bg-cyan-600"
                  aria-hidden="true"
                />
              ) : null}
              <div className="group relative flex items-start">
                <span className="flex h-9 items-center">
                  <span className="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-cyan-600 group-hover:bg-cyan-800">
                    <CheckIcon
