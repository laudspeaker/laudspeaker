  ...
  return (
    ...
    >
      <div className="flex flex-col gap-[8px]">
        <div
          className={`w-full h-[50px] flex items-center gap-[20px] ${
            isExpanded ? "" : "justify-center"
          }`}
        >
          <div className="w-[30px] h-[30px] flex items-center justify-center">
            <img className="w-[15px] h-[20px]" src={laudspeakerIcon} />
          </div>
          {isExpanded && (
            <svg
              width="102"
                    ...
                    {({ open }) => (
                      <div className="flex flex-col gap-[8px]">
                        <Disclosure.Button className="w-full">
                          ...
                          >
                            <div className="flex items-center justify-center w-[30px] h-[30px] rounded-[4px]">
                              <img src={navigationItem.imgIcon} />
                            </div>
                            {isExpanded && navigationItem.text}
                            {isExpanded && (
                              <div
